...
Revision ID: 5214ed21d970
Revises: 
Create Date: 2024-12-03 10:44:54.153108
...
def upgrade() -> None:
    ...
    op.create_table('refresh_token_session',
    ...
    sa.Column('main_dish', postgresql.ENUM('rot', 'blau', name='maindish', create_type=False), nullable=True),
    sa.Column('salad_option', sa.Boolean(), nullable=False),
    sa.Column('handed_out', sa.Boolean(), nullable=True),
    sa.ForeignKeyConstraint(['person_id'], ['person.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('old_order',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('person_id', sa.UUID(), nullable=False),
    ...
    sa.Column('user_group', postgresql.ENUM('verwaltung', 'standortleitung', 'gruppenleitung', 'kuechenpersonal', name='usergroup', create_type=False), nullable=False),
    ...
    sa.Column('user_id_location_leader', sa.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['user_id_location_leader'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.ForeignKeyConstraint(['user_id_groupleader'], ['user.id'], ),
    sa.ForeignKeyConstraint(['user_id_replacement'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
